...
<head>
    ...
    <link rel="icon" href="<?php echo base_url('assets/img/long-logo.png') ?>">
    <meta charset="utf-8">
                ...
                <form action="<?= base_url() ?>auth/authentication" method="POST" class="signin-form">
                    <div class="login-box">
                        ...
                        <div class="login-header">
                            <h5 class="mb-2 p-0">Login</h5> <span>Sistem Informasi Penjadwalan Mata Pelajaran SMKN 04 Kendari</span>
                        </div>
