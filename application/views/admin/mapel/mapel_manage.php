<div class="px-4 py-3">
            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h3 class="m-b-10" style="font-weight:bold">Halaman Data Mata Pelajaran Yang Terdaftar</h3>
                        <p>Berikut merupakan halaman untuk mengelola mata pelajaran yang akan di pelajari</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="button-place mb-3">
        <a href="<?= base_url('admin/mapel/mapel_add') ?>" class="btn btn-unique"><i class="fas fa-plus"></i> Tambah Mata Pelajaran</a>
                            ...
                            <tbody>
                                <?php $no = 1; foreach($list as $l) {?>
                                    <tr>
                                        ...
                                        <!-- <td>0</td> -->
                                        <td width="10%">
                                            <a href="<?= base_url()?>admin/mapel/mapel_edit/<?= $l['id']?>" class="btn btn-warning btn-sm"><i class="fas fa-pencil-alt"></i></a>
        ...
        <div class="modal-dialog modal-dialog-centered w-25" role="document">
            <div class="modal-content">
                <div class="modal-body">
                        ...
                        <?= form_open('admin/mapel/mapel_delete') ?>
