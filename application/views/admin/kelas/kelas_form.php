            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <label for="" class="col-1">Level Kelas</label>
                        <div class="col-5">
                            <?= form_dropdown('levelKelas', array('10' => '10', '11' => '11', '12' => '12'), $inkelas['kelas_level'], 'class="form-control form-control-sm"') ?>
                            <small>Pilih Level Kelas Disini</small>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group" id="bodyAppendMapel">
                        ...
                        <?php $id_mapel = '';
                        if (isset($regist_mapel)) {
                            foreach ($regist_mapel as $g) {
                                $id_mapel .= $g['id'] . ',' ?>
